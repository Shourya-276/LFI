...
const DisbursementManagement = () => {
  ...
  const pendingData = [
    { leadId: "#8232", leadName: "Rajesh Sharma", bankName: "HDFC Bank", pendingDocs: "Form, Doc1,Doc2", action: "Upload" },
    { leadId: "#1232", leadName: "Priya Mehta", bankName: "SBI", pendingDocs: "Form, Doc1,Doc2", action: "Upload" },
    { leadId: "#4232", leadName: "Anil Gupta", bankName: "HDFC Bank", pendingDocs: "Form, Doc1,Doc2", action: "Upload" },
    { leadId: "#1232", leadName: "Priya Mehta", bankName: "SBI", pendingDocs: "Form, Doc1,Doc2", action: "Upload" },
    { leadId: "#8232", leadName: "Rajesh Sharma", bankName: "HDFC Bank", pendingDocs: "Form, Doc1,Doc2", action: "Upload" },
    { leadId: "#4232", leadName: "Anil Gupta", bankName: "HDFC Bank", pendingDocs: "Form, Doc1,Doc2", action: "Upload" }
  ];
  ...
  const completedData = [
    { leadId: "#8232", leadName: "Rajesh Sharma", bankName: "HDFC Bank", status: "Approved", utrNumber: "#12317717717" },
    { leadId: "#8232", leadName: "Rajesh Sharma", bankName: "HDFC Bank", status: "Approved", utrNumber: "#12317717717" },
    { leadId: "#8232", leadName: "Rajesh Sharma", bankName: "HDFC Bank", status: "Approved", utrNumber: "#12317717717" },
    { leadId: "#8232", leadName: "Rajesh Sharma", bankName: "HDFC Bank", status: "Approved", utrNumber: "#12317717717" }
  ];
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead>
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">
                    {activeTab === "pending" ? "Upload Action" : "UTR Number"}
                  </th>
                </tr>
              </thead>
