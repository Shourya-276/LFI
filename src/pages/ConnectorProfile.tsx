    ...
    <div className="space-y-2">
      ...
      <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-500">Drag file here or <button className="text-blue-600 underline">Browse</button></p>
        </div>
        <input
          type="file"
          className="hidden"
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-xs text-gray-500 mb-4">JPG/PNG/PDF format accepted</p>
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center w-48">
              <div className="space-y-2">
                ...
                <button className="text-blue-600 text-sm underline">Browse</button>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-4 mt-8">
            <Button variant="outline" className="px-8">Clear</Button>
